namespace ts {
    ...
    export interface Node extends TextRange {
        ...
        /* @internal */
        jsDocComments?:JSDocComment[]; // JSDoc for the node, if it has any.  Only for .js files.
        /* @internal */
    ...
    export interface Symbol {
        ...
        /* @internal */
        isReadonly?:boolean;   // readonly? (set only for intersections and unions)
        /* @internal */
        ...
        /* @internal */
        isReferenced?:boolean; // True if the symbol is referenced elsewhere
        /* @internal */
